            ...
            <div class="col-container">
              ...
              >
                <div class="card-body">
                  ...
                  <p class="card-text">
                    A web app that, when provided a github link, generates a
                    confluence page describing what the app does based on
                    classes/methods within. This process will work on most
                    mainstream languages, but will be implemented focusing on a
                    Java source code target.{" "}
                  </p>
                </div>
              </animated.div>
              <animated.div
